...
public class Generator {
    public static void main(String[] args) {
        // 表名字，多个用 ， 分割
        String tables = "help_mess";
        // 文件输出目录的模块或者项目的地址:
        String projectPath = "D:\\school\\progect\\school_clould\\school_cloud\\help_about";
        // 代码生成器
        ...
        gc.setEntityName("%sMQEntity");            //实体命名方式  默认值：null 例如：%sEntity 生成 UserEntity
        ...
        dsc.setUrl("jdbc:mysql://119.3.172.171:3300/schools?useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        pc.setModuleName("D:/school/school_clould/school_cloud/help_about/src/test");//模块名F:\4User\cf-spring-boot\src\main\java\com\springboot\test
        pc.setParent("com.help.test");
        //自定义包配置
